...
void init_scene_04b_talk_to_sister_curious(StoryScene* scene) {
    ...
    scene->dialogue_lines[1] = (DialogueLine){.speaker_id = SPEAKER_MIRA, .text_id = TEXT_SISTER_CURIOUS_QUOTE1};
    scene->dialogue_lines[2] = (DialogueLine){.speaker_id = SPEAKER_MIRA, .text_id = TEXT_SISTER_CURIOUS_QUOTE2};
    scene->dialogue_lines[3] = (DialogueLine){.speaker_id = SPEAKER_MIRA, .text_id = TEXT_SISTER_CURIOUS_QUOTE3};
    scene->dialogue_lines[4] = (DialogueLine){.speaker_id = SPEAKER_MIRA, .text_id = TEXT_SISTER_CURIOUS_QUOTE4};
