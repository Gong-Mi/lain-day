...
void init_scene_04c_talk_to_sister_default(StoryScene* scene) {
    ...
    scene->text_content_ids[1] = TEXT_SISTER_DEFAULT_QUOTE1; // Conditional part
    scene->text_content_ids[2] = TEXT_SISTER_DEFAULT_QUOTE2; // Conditional part
    scene->text_content_ids[3] = TEXT_SISTER_DEFAULT_YOU_QUOTE1; // Conditional part
    scene->text_content_ids[4] = TEXT_SISTER_DEFAULT_QUOTE3; // Conditional part
