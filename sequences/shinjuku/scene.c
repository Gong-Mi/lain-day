...
int create_shinjuku_layout(Location* all_locations, int starting_index) {
    ...
    init_location(shinjuku_station, "shinjuku_station", get_string_by_id(TEXT_SCENE_NAME_MIYANOSAKA_STATION), "这是新宿站，一个繁忙的交通枢纽。"); // Reusing string ID for now
    ...
    add_poi_to_location(shinjuku_abandoned_site, "rusty_equipment", "生锈的设备", "一些废弃的、生锈的建筑设备，看起来很危险。", NULL);
