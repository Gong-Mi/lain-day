...
int main(int argc, char *argv[]) {
    ...
    pthread_create(&time_thread_id, NULL, time_thread_func, &game_state);
...
#endif
        print_colored_line(scene->dialogue_lines[i].speaker_id, scene->dialogue_lines[i].text_id, game_state);
    }
